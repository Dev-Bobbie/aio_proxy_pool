...
from utils import fetch,get_cookie
...
class Crawler:
    ...
    def ip_66():
        ...
        url = 'http://www.66ip.cn/nmtq.php?getnum=100&isp=0&anonymoustype=0&start=&ports=&export=&ipaddress=&area=0&proxytype={}&api=66ip'
        pattern = "\d+\.\d+.\d+\.\d+:\d+"
